...
var coords = [{x: -1.000, y: -1.000, z: -1.000}, {x: -1.000, y: -1.000, z: 1.000},
    ...
    {x: 1.000, y: -1.000, z: -1.000}, {x: 1.000, y: -1.000, z: 1.000},
    {x: 1.000, y: 1.000, z: -1.000}, {x: 1.000, y: 1.000, z: 1.000}];
var coords_cpy = [{x: -1.000, y: -1.000, z: -1.000}, {x: -1.000, y: -1.000, z: 1.000},
    {x: -1.000, y: 1.000, z: -1.000}, {x: -1.000, y: 1.000, z: 1.000},
    {x: 1.000, y: -1.000, z: -1.000}, {x: 1.000, y: -1.000, z: 1.000},
    {x: 1.000, y: 1.000, z: -1.000}, {x: 1.000, y: 1.000, z: 1.000}];
    ...
    var r_copy = angular.copy(r);
        ...
        for (var s = 0; s < 6; s++)
        {
            ...
            for (var l = 0; l < 5; l++)
            {
                ...
                var corner_save = angular.copy(corner);
                switch(l) {
                    case 0:
                ...
                corner_save.x = (corner.x * (half / 1.500)) * ((corner.z + 8) / 10) + half;
                corner_save.y = (corner.y * (half / 1.500)) * ((corner.z + 8) / 10) + half;
                corner_save.z = -1;
                r_copy[side[l%4]] = corner_save;
            }
            ctx.closePath();
            ctx.stroke();
            ctx.fill();
            if (side[4] == 0 || side[4] == 5)
                drawSide(shapes[side[4]], side[4]);
            if (side[4] == 4)
                drawCurves();
            if (side[4] == 1)
            {
                ...
                if (iteration > 0)
                {
                    coords = angular.copy(r_copy);
                    draw(rotate_y(n2, rotate_x(n1)), iteration - 1);
                }
            }
    }
}
...
function drawBack()
{
    ...
    var this_shape = rotate_ys(n2, rotate_xs(n1, black));
...
function drawCurves()
{
    ...
    var this_shape = rotate_ys(n2, rotate_xs(n1, hash));
...
app.directive('pressKey', function() {
    return function($scope, $elem) {
        $elem.bind("keydown", function(e){
            ...
            {
                coords = angular.copy(coords_cpy);
                draw(rotate_y(n2, rotate_x(n1)), 5);
            }
        });
    };
});
...
app.controller("mainController", ['$scope', function ($scope) {
  ...
  s.mouseMove = function(event){
    if (boolean)
    {
      ...
      coords = angular.copy(coords_copy);
      draw(rotate_y(n2, rotate_x(n1)), 5);
    }
  };
