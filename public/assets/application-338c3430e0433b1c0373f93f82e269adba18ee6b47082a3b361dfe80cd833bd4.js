...
app.controller("mainController", ['$scope', 'Main', function ($scope, Main) {
  ...
  var n2 = 0;
  s.data = {};
  var coords = [{x: -1, y: -1, z: -1}, {x: -1, y: -1, z: 1},
                {x: -1, y: 1, z: -1}, {x: -1, y: 1, z: 1},
                {x: 1, y: -1, z: -1}, {x: 1, y: -1, z: 1},
                {x: 1, y: 1, z: -1}, {x: 1, y: 1, z: 1}];
  var lines = [[1,3], [3,7], [7,5], [5,1],
               [0,2], [2,6], [6,4], [4,0],
               [0,1], [2,3], [4,5], [6,7]];
  ...
  function rotate(x, y)
  {
    ...
    {
      r[c] = {x: n[c].x,
              y: n[c].y * Math.cos(x % 360) - n[c].z * Math.sin(x % 360),
              z: n[c].y * Math.sin(x % 360) + n[c].z * Math.cos(x % 360)};
      n[c] = r[c];
      r[c] = {x: n[c].x * Math.cos(y % 360) + n[c].z * Math.sin(y % 360),
              y: n[c].y,
              z: n[c].z * Math.cos(y % 360) + n[c].x * Math.sin(y % 360)};
    }
    return r;
  }
  ...
  function draw(r)
  {
    ...
    for (var l = 0; l < 12; l++)
    {
      ...
      var a = r[line[0]];
      var b = r[line[1]];
      ctx.moveTo((a.x * 300) * ((a.z + 3) / 10) + 300,
                 (a.y * 300) * ((a.z + 3) / 10) + 300);
      ctx.lineTo((b.x * 300) * ((b.z + 3) / 10) + 300,
                 (b.y * 300) * ((b.z + 3) / 10) + 300);
    }
    ctx.stroke();
  }
