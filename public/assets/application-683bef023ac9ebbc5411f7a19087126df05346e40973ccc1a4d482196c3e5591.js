...
function drawBack(repeat)
{
    ...
    var this_shape = repeat == 10 ? rotate_ys(n2, rotate_xs(n1, black)) : rotate_ys(n2, rotate_xs(n1, new_black));
    ...
    for (var z = 1; z < 5; z++)
    {
        ...
        new_back[z%4] = {};
        new_back[z%4].x = 0 - this_shape[z%4].x * ((this_shape[z%4].z + 8) / 10);
        new_back[z%4].y = this_shape[z%4].y * ((this_shape[z%4].z + 8) / 10);
        new_back[z%4].z = -1;
    }
    ctx.closePath();
    ctx.fill();
