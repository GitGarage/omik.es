...
app.controller("mainController", ['$scope', 'Main', function ($scope, Main) {
  ...
  function rotate(x, y)
  {
    ...
    {
      r[c] = {x: n[c].x,
              y: n[c].y * Math.cos(0 - x) - n[c].z * Math.sin(0 - x),
              z: n[c].y * Math.sin(0 - x) + n[c].z * Math.cos(0 - x)};
      n[c] = r[c];
  ...
  function draw(r)
  {
    ...
    for (var l = 0; l < 12; l++)
    {
      ...
      var a = r[line[0]];
      var b = r[line[1]];
      ctx.moveTo((a.x * 300) * ((a.z + 4) / 10) + 300,
                 (a.y * 300) * ((a.z + 4) / 10) + 300);
      ctx.lineTo((b.x * 300) * ((b.z + 4) / 10) + 300,
                 (b.y * 300) * ((b.z + 4) / 10) + 300);
    }
    ctx.stroke();
  }
