...
function draw(r, repeat)
{
    ...
    for (var s = 0; s < 6; s++)
    {
        ...
        for (var l = 0; l < 5; l++)
        {
            ...
            new_coords[side[l % 4]] = {};
            new_coords[side[l % 4]].x = 0 - corner.x * ((corner.z + 8) / 10) * 0.800;
            new_coords[side[l % 4]].y = corner.y * ((corner.z + 8) / 10) * 0.800;
        ...
        //     {
        //         //drawBack();
        //         draw(rotate_ys(n2, rotate_xs(n1, angular.copy(new_coords))), repeat - 1);
        //     }
        // }
    }
}
...
app.controller("mainController", ['$scope', function ($scope) {
  ...
  s.mouseMove = function(event){
    if (boolean)
    {
      ...
      draw(rotate_y(n2, rotate_x(n1)), 1);
    }
  };
