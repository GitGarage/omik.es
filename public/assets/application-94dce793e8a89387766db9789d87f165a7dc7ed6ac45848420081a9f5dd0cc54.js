...
{
    hashma =  = [{z: -1.000, y: -1.000, x: -1.000}, {z: 1.000, y: -1.000, x: -1.000},
...
var hashma =  = [{z: -1.000, y: -1.000, x: -1.000}, {z: 1.000, y: -1.000, x: -1.000},
    {z: 1.000, y: 1.000, x: -1.000}, {z: -1.000, y: 1.000, x: -1.000}];

function drawCurves()
{
    var this_shape = rotate_ys(n2, rotate_xs(n1, hashma));
    hashma = [];
    ...
    for (var z = 0; z < 4; z++)
    {
        ...
        hashma[z%4] = {};
        hashma[z%4].x = 0 - this_shape[z%4].x * ((this_shape[z%4].z + 8) / 10) * 0.600;
        hashma[z%4].y = this_shape[z%4].y * ((this_shape[z%4].z + 8) / 10) * 0.600;
        hashma[z%4].z = -1;
    }
}
