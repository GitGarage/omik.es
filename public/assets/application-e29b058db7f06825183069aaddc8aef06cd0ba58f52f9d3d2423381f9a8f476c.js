...
function drawCurves(repeat)
{
    ...
    if (repeat == 10)
    {
        for (var i = 10; i > 0; i--)
        {
            if (i == 10)
            {
                curves[i] = rotate_ys(n2, rotate_xs(n1, hash));
            }
            else
            {
                curves[i] = [];
                ...
                {
                    curves[i][z%4] = {};
                    curves[i][z%4].z = 0 - curves[i+1][z%4].x * ((curves[i+1][z%4].z + 8) / 10) * 0.600;
                    curves[i][z%4].y = curves[i+1][z%4].y * ((curves[i+1][z%4].z + 8) / 10) * 0.600;
                    curves[i][z%4].x = -1;
                }
            }
        }
