...
function draw(r, repeat)
{
    ...
    for (var s = 0; s < 6; s++)
    {
        ...
        for (var l = 0; l < 5; l++)
        {
            ...
            new_coords[side[l % 4]] = {};
            new_coords[side[l % 4]].x = corner.x * ((corner.z + 8) / 10);
            new_coords[side[l % 4]].y = corner.y * ((corner.z + 8) / 10);
        ...
        if (side[4] == 1)
        {
            ...
            if (repeat > 0)
            {
                coords = angular.copy(new_coords);
                draw(rotate_y(n2, rotate_x(n1)), repeat - 1);
            }
        }
    }
}
